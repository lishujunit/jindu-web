<template>
  <div
    :style="style"
    :class="['vdr', active || isActive ? 'active' : 'inactive']"
  ...
  >
    ...
    <div
      ...
      :key="index"
      :class="['vdr-stick', 'vdr-stick-' + stick, isResizable ? '' : 'not-resizable']"
...
export default {
  ...
  methods: {
    ...
    bodyMove(ev) {
      ...
      this.$emit("dragging", this.rect, this.windowId);
    },

    bodyUp() {
      this.bodyDrag = false;
      this.$emit("dragging", this.rect, this.windowId);
      this.$emit("dragstop", this.rect, this.windowId);
    ...
    stickDown: function(stick, ev) {
      this.$emit("stickDown", this.windowId);
      this.active = true;
    ...
    stickMove(ev) {
      ...
      this.$emit("resizing", this.rect, this.windowId);
    },
    ...
    stickUp() {
      ...
      this.$emit("resizing", this.rect, this.windowId);
      this.$emit("resizestop", this.rect, this.windowId);
    },
